...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] text-white overflow-x-hidden font-paragraph selection:bg-[#00eaff] selection:text-black flex items-center justify-center px-3 md:px-4">
      {/* Atmospheric Background Elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-48 h-48 md:w-96 md:h-96 bg-[#FF4500]/5 rounded-full blur-[80px] md:blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-[500px] md:h-[500px] bg-[#00eaff]/5 rounded-full blur-[100px] md:blur-[150px]" />
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md mx-auto py-8"
      >
        <div className="text-center mb-8 md:mb-12">
          ...
          >
            <Image 
              ...
              className="w-32 h-auto md:w-48 md:h-auto object-contain"
              width={192}
            />
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-heading font-black text-2xl md:text-5xl tracking-[2px] uppercase mb-2"
            style={{
          ...
          <motion.p
            ...
            className="font-heading font-bold text-lg md:text-3xl tracking-[1px] uppercase text-[#00eaff] drop-shadow-[0_0_5px_rgba(0,234,255,0.8)]"
          >
            Seja o Rei do Crime
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-b from-[rgba(15,20,30,0.95)] to-[rgba(15,20,30,0.85)] border-2 border-[#00eaff] rounded-lg p-4 md:p-8 shadow-[0_0_30px_rgba(0,234,255,0.3)]"
          style={{
        ...
        >
          ...
          {error && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 md:mb-6 p-3 bg-red-500/20 border border-red-500/50 rounded text-red-300 text-xs md:text-sm font-paragraph"
            >
              {error}
            </motion.div>
          )}
          ...
          <div className="mb-4 md:mb-6">
            <label className="block text-[#00eaff] font-heading text-xs md:text-sm tracking-wider uppercase mb-2 md:mb-3">
            ...
            <input
              ...
              maxLength={20}
              className="w-full bg-black/40 border-2 border-[#00eaff]/30 rounded px-3 md:px-4 py-2 md:py-3 text-white font-paragraph placeholder-white/40 focus:outline-none focus:border-[#00eaff] transition-colors mb-2 md:mb-3 text-sm md:text-base"
            />
            <button
              onClick={() => handleLogin('guest')}
              disabled={isLoading}
              className="w-full py-2 md:py-3 bg-gradient-to-r from-[#00eaff]/20 to-[#00eaff]/10 border-2 border-[#00eaff] rounded font-heading font-bold text-[#00eaff] tracking-wider uppercase hover:from-[#00eaff]/30 hover:to-[#00eaff]/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-xs md:text-sm"
              style={{
          ...
          {/* Info Text */}
          <p className="mt-4 md:mt-6 text-center text-white/60 font-paragraph text-xs md:text-sm leading-relaxed">
