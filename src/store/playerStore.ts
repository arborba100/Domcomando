...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-2 md:px-3 pt-1">
      <div
        className="mx-auto max-w-[1680px] overflow-hidden rounded-[24px] border shadow-[0_0_40px_rgba(0,0,0,0.5)]"
        style={{
        ...
        <div className="relative">
          ...
          <div className="relative px-3 md:px-4 py-2">
            <div className="flex flex-col 2xl:flex-row 2xl:items-center 2xl:justify-between gap-3">
              {/* LOGO */}
              <div className="flex items-center justify-center 2xl:justify-start min-w-[190px]">
                <div className="relative">
              ...
              <div className="flex-1">
                <div className="rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] backdrop-blur-xl px-3 md:px-4 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_30px_rgba(0,0,0,0.2)]">
                  <div className="flex flex-col xl:flex-row xl:items-center gap-3">
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      <div className="relative shrink-0">
                        ...
                        <div className="relative w-[64px] h-[64px] rounded-full overflow-hidden border-[3px] border-black/60 shadow-[0_0_30px_rgba(255,200,0,0.35)]">
                          <Image
                            src={avatarUrl}
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          {editingName ? (
                            <input
                              ...
                              autoFocus
                              className="bg-black/70 border border-yellow-500/60 rounded-md px-2 py-1 text-yellow-300 font-black text-lg md:text-xl outline-none w-[180px] md:w-[220px]"
                            />
                          ) : (
                            <div
                            ...
                            >
                              <span className="text-yellow-300 font-black text-lg md:text-xl truncate tracking-wide drop-shadow-[0_0_10px_rgba(255,200,0,0.18)] max-w-[180px] md:max-w-[240px]">
                        ...
                        <div className="mt-1.5 flex flex-wrap items-center gap-2">
                          <div className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-red-700 via-red-600 to-red-700 text-white text-[10px] md:text-[11px] px-3 py-1 font-black uppercase tracking-[0.18em] shadow-[0_0_18px_rgba(255,0,0,0.18)]">
                            <Shield className="w-3.5 h-3.5" />
                            COMANDANTE DE ELITE
                          </div>

                          <div className="inline-flex items-center gap-1 rounded-md border border-yellow-500/30 bg-yellow-500/10 text-yellow-200 text-[10px] md:text-[11px] px-2 py-1 font-bold uppercase tracking-[0.14em]">
                    ...
                    {member?._id && (
                      <div className="shrink-0">
                        <button
                          ...
                          className="w-full xl:w-auto flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5 text-white font-black tracking-[0.08em] border border-cyan-300/20 bg-gradient-to-r from-cyan-600 via-sky-600 to-blue-700 hover:from-cyan-500 hover:via-sky-500 hover:to-blue-600 shadow-[0_0_24px_rgba(0,180,255,0.25)] transition-all"
              ...
              <div className="min-w-[210px]">
                <div className="rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(0,0,0,0.4),rgba(255,255,255,0.02))] px-4 py-3 backdrop-blur-xl text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                  ...
                  <div className="flex gap-2 justify-center mt-2.5">
                    {formatTimer(formatTime(timeUntilNextGain)).map((t, i) => (
                      <div
                        key={i}
                        className="min-w-[52px] rounded-xl px-3 py-2.5 text-lg font-black text-white border shadow-[0_0_18px_rgba(0,0,0,0.28)]"
                        style={{
                          background:
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-2xl border border-white/10 bg-black/30 px-3 py-2.5 text-center ${toneClasses[tone].glow} shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]`}
    >
      <div
        className={`flex items-center justify-center gap-1 text-[11px] uppercase tracking-[0.14em] ${toneClasses[tone].label}`}
      >
        {icon}
        <span>{label}</span>
      </div>
      <div className="mt-1.5 text-white font-black text-base md:text-lg tracking-wide">
        {value}
      </div>
    </div>
  );
